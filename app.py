...
# Fix for Windows event loop (important for local development on Windows)
...
# ✅ Correct model loading using proper task and model_name
...
def load_emotion_model():
    ...
    return modeling.build_model(task='emotion', model_name='Emotion')
            ...
            try:
                ...
                if self.live_result:
                    ...
                    result = DeepFace.analyze(
                        ...
                        models={'emotion': emotion_model}  # Use preloaded model
